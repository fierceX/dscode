...
pub mod prelude {
    ...
    pub use crate::runtime::{
        ...
        OpenAiCompatibleOptions, OutputFormat, PostInitContext, PostInitHook, PrefixSource,
        ProviderOptions, ReadOnlyFileSystem, ResolvedModel, ResourceHandler, RuntimeError,
        RuntimeSkill, SandboxConfig, SandboxPythonConfig, SessionInfo, SessionLayout,
        SessionPolicy, SignalPolicy, SkillCapability, SkillDiscoveryPolicy, SkillLoadContext,
        SkillProvider, SourceLevel, SourceMeta, TokenParamKind, ToolActivation, ToolApprovalMode,
        ToolApprovalPolicy, ToolCapabilityOffer, ToolDefinition, ToolError, ToolExecutionContext,
        ToolExecutionMode, ToolOptions, ToolOutput, ToolSemanticCapability, TurnId, TurnOutcome,
        TurnStatus, VfsGlobRequest, VfsGlobResult, VfsGrepEntry, VfsGrepRequest, VfsGrepResult,
        VfsReadRequest, VfsReadResult, VfsScope,
    };
}
